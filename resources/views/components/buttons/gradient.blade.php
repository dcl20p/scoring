...
@php
    ...
    $innerClasses = "relative inline-flex items-center justify-center w-full px-5 py-2.5 font-bold text-gray-500 hover:text-white dark:hover:text-white dark:text-gray-300 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent";
@endphp
